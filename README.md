...
* **Vocal Layer:** To prevent broken, robotic pronunciation, the code dynamically maps matching **native Malayalam script** directly to the text-to-speech driver(TTS). 
