...
* **Visual Layer:** The GUI displays crisp, casual **Manglish layout** text using classic regional expressions like *Entheru pfrene, Aliya, Dei makkale, Scene aanu,* and *Set aanu*.
